  ...
  async function fetchUserSkills() {
    try {
      const response = await axios.get<UserSkill[]>(
        `https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/public/user-skills/filter?userGeneral.userGeneralId=${userGeneralId}`,
        axiosConfig
      );
    ...
    if (query.length > 2) {
      try {
        const response = await axios.get<SkillDto[]>(
          `https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/public/skill/search?q=${encodeURIComponent(query)}`,
          { headers: { Authorization: `Bearer ${token}` } }
        );
  ...
  const handleAddSkill = async () => {
    ...
    try {
      ...
      const searchRes = await axios.get<SkillDto[]>(
        `https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/public/skill/search?q=${encodeURIComponent(skillForm.name)}`,
        axiosConfig
      );
      ...
      if (existingSkill) {
        ...
        const createSkillRes = await axios.post(
          `https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/public/skill`,
      ...
      await axios.post(
        `https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/public/user-skills`,
        {
          skill: { skillId },
  ...
  const handleUpdateSkill = async () => {
    ...
    try {
      ...
      const checkRes = await axios.get<UserSkill[]>(
       ` https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/public/user-skills/filter?userGeneral.userGeneralId=${userGeneralId}&skill.skillId=${skillForm.skillId}`,
        axiosConfig
      );
     ...
     await axios.put(
  `https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/public/user-skills/${selectedSkill.userSkillsId}`,
 {
  ...
  const handleDeleteSkill = async (id: number) => {
    try {
      await axios.delete(`https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/public/user-skills/${id}`, axiosConfig);
      await fetchUserSkills();
    } catch (error) {
