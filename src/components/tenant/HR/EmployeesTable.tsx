...
export function EmployeesTable() {
    ...
    const fetchAllData = async () => {
      try {
        const [userTenantRes, departmentRes, contractsRes] = await Promise.all([
          axios.get("https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/tenant/user-tenant", {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get("https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/tenant/department", {
            headers: { Authorization: `Bearer ${token}` },
          }),
          axios.get("https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/tenant/contracts", {
            headers: { Authorization: `Bearer ${token}` },
          }),
        ])
  ...
  const handleDelete = async (id: number) => {
    try {
      await axios.delete(`https://humanresourcemanagementsystemback-production.up.railway.app/api/v1/tenant/user-tenant/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
